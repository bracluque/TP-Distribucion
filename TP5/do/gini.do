...
program define gini, rclass
  version 8.0
  syntax varlist(max=1) [if] [fweight], [Reps(passthru)] [SAving(passthru)] [replace] [Dots] [bs]
...
* BOOTSTRAP +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  if "`bs'" != "" {
    ...
    tempname aux
    matrix `aux' = e(ci_normal)
    return scalar ci_nor_ll = `aux'[1,1]
    return scalar ci_nor_ul = `aux'[2,1]
